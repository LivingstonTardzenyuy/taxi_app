...
import 'package:taxi_app/client_app/authentication/screens/create_account_screen.dart';
import 'package:taxi_app/client_app/authentication/screens/forgot_password/forgot_password_one.dart';
...
class _SignInScreenClientState extends State<SignInScreenClient> {
  ...
  void _signIn() {
    Get.to(() => const ClientBottomNavigationBar());
  }
  ...
  child: TextButton(
    onPressed: () {
      Get.to(() => const ForgotPasswordOne());
    },
    child: const Text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 (
      'Forgot Password?',
      style: TextStyle(
