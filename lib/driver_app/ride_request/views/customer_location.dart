            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                Padding(
                  ...
                  child: Row(children: [
                    const CircleAvatar(radius: 22, backgroundImage: AssetImage('assets/images/img.png'), backgroundColor: Colors.white),
                ...
                Padding(padding: const EdgeInsets.symmetric(horizontal: 16), child: _locationRow(Icons.radio_button_checked, 'Reding Town Last Town')),
                const SizedBox(height: 12),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  child: SizedBox(width: double.infinity, child: PrimaryButton(label: showCountdown ? 'Continue' : "Navigate To Customer's Location", onPressed: () {})),
                ),
              ]),
            ),
          ),
